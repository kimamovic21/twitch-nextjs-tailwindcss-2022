...
const account = () => {
    ...
    if (session) {
      return (
        <div className='pt-[100px] flex flex-col max-w-[400px] w-full mx-auto p-4'>
          ...
          <button className='flex items-center justify-center p-3 bg-gray-600 border border-gray-600'
                  onClick={() => signOut()}>
                    Sign out
        </button>
        </div>
    ...
    return (
      <div className='pt-[100px] flex flex-col max-w-[400px] w-full mx-auto p-4'>
        ...
        <button className='flex items-center justify-center p-3 bg-gray-600 border border-gray-600 rounded-xl'
                onClick={() => signIn()}>
            <FaGithub className='mr-2'/> Sign in with 
            <span className='font-bold pl-1'>Github</span>
        </button>

        <button className='flex items-center justify-center p-3 bg-blue-600 border border-blue-600 mt-3 rounded-xl'
                onClick={() => signIn()}>
